function C = meas_capacity(com_load,com_psupply,com_temperature,discharge_voltage,charge_voltage,discharge_current,charge_current,end_current)
%meas_capacity: measures capacity of cell over 2 cycles
    ...
    discharge_cell(device_load,obj_load,device_psupply,obj_psupply,device_temperature,discharge_voltage,discharge_current,0,0,end_current,plot_ctrl);
